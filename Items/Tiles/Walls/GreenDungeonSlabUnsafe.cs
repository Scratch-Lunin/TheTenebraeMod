...
{
    public class GreenDungeonSlabUnsafe : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Unsafe Green Slab Wall");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.GreenSlabWall);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(this);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod); // 1 Unsafe Wall ---> 1 Wall
            recipe.AddIngredient(null, "GreenDungeonSlabUnsafe");
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ItemID.GreenSlabWall);
            recipe.AddRecipe();
