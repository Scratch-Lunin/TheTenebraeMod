	...
	public class BinaryStarProjectile : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Projectiles/BinaryStarChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
					new Rectangle(0, 0, 28, 10), Color.White, projRotation,
					new Vector2(28 * 0.5f, 10 * 0.5f), 1f, SpriteEffects.None, 0f);
			}

            spriteBatch.Draw(mod.GetTexture("Projectiles/BinaryStarProjectile"), new Vector2(projectile.Center.X - Main.screenPosition.X, projectile.Center.Y - Main.screenPosition.Y),
