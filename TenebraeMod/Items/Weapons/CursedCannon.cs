...
{
    public class CursedCannon : ModItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            if (Main.rand.NextBool(5))
            {
                ...
                Projectile.NewProjectile(position.X, position.Y, speedX, speedY, ModContent.ProjectileType<CursedCannonBullet>(), damage, knockBack, player.whoAmI);
