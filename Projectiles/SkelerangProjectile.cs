    ...
    public class SkelerangProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            if (boneTimer < 120)
            {
                ...
                if (boneTimer % 5 == 0)
                {
                    var proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, (float)-0.5, ModContent.ProjectileType<SkelerangBone>(), projectile.damage / 2, projectile.knockBack, projectile.owner, projectile.whoAmI);
